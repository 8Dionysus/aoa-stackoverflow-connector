# aoa-stackoverflow-connector Local KAG Provider

`kag/` exposes the current StackOverflow connector provider packet as portable
...
| Field | Route |
| --- | --- |
| role | local KAG provider for StackOverflow connector policy, storage boundary, and runtime contract handles |
